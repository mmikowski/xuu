...
- 1.7.12 Updates minified version to include 1.7.11 changes.
...
The following is autogenerated from the Xuu function documentation.

### Variable Type and Cast Methods
These are required for other methods and are therefore shown first in
alphabetical order.
