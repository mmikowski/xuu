...
var xuu = (function () {
  ...
  var
    ...
    clearToFn       = clearTimeout,
    data2strFn      = JSON.stringify,
    makeAbsNumFn    = __Math.abs,
    makeFloorNumFn  = __Math.floor,
    makeKeyListFn   = __Object.keys,
    makeRandomNumFn = Math.random,
    makeRoundNumFn  = Math.round,
    setToFn         = setTimeout,
    str2dataFn      = JSON.parse,
